...
<html lang="en">
    ...
    <div class="col-md-12 col-lg-12 col-sm-12" style="background-color:#FFDA00;color:#211c02;text-align:center">Esta es una cuenta para demostraci&oacute;n</div>
    <body>
    <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="<?php echo $this->config->item('url_sistema');?>">
            <img src="<?=base_url("assets/img/logo.png")?>" class="img-fluid float-left d-block max_height_33px">
        </a>
